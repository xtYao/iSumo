...
## large number of trees without balancing
...
## are about the same. Choose the simpler one.
## it is far from the best training error achieved by balancing labels,
## but much less overfitting and better validation performance.
## save it
